...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if ($update) {
    echo "<script>alert('Data peserta berhasil diperbarui'); window.location='edit_acara.php?id=$id_acara';</script>";
    exit;
  } else {
  ...
  <div class="card-glass">
    ...
    <form method="POST" onsubmit="return handleSubmit()">
      ...
      <div class="mb-3">
        ...
        <textarea name="alamat" id="alamat" class="form-control" rows="3" required><?= htmlspecialchars($peserta['alamat']) ?></textarea>
      </div>
      <div class="mb-3">
      ...
      <div class="d-flex gap-2 flex-wrap">
        ...
        <a href="edit_acara.php?id=<?= $id_acara ?>" class="btn btn-secondary">
