  ...
  <div class="card-glass mb-4">
    <div class="d-flex flex-wrap justify-content-between align-items-center">
      ...
      <div class="d-flex flex-wrap gap-2 mt-3 mt-md-0">
        <a href="tambah_peserta_kuliah.php?id=<?= $id_acara ?>" class="btn btn-success btn-modern">
          <i class="fas fa-user-plus"></i> <span>Tambah Peserta</span>
        </a>
        <a href="export_docx_kuliah.php?id=<?= $id_acara ?>" class="btn btn-primary btn-modern">
...
function copyShareLink() {
  ...
  const link = `${window.location.origin}/tambah_peserta_kuliah_public.php?id=${idAcara}`;
