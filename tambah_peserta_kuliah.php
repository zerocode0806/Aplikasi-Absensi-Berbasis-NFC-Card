...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $nim = (int) $_POST['nim']; // pastikan nim integer
  ...
  if (mysqli_query($koneksi, $query)) {
    echo "<script>alert('Peserta berhasil ditambahkan'); window.location='absen_kuliah.php?id=$id_acara';</script>";
  } else {
  ...
  <div class="card-glass">
    ...
    <form method="POST" onsubmit="return handleSubmit()">
      ...
      <div class="d-flex gap-2 flex-wrap">
        ...
        <a href="absen_kuliah.php?id=<?= $id_acara ?>" class="btn-modern btn-secondary">
